...
<?php while($row = mysql_fetch_row($result)): ?> 
	<form method="POST">
		...
		<img src="http://www.mtv.com/shared/droplets/media/normalize_jpeg.jhtml?width=175&height=175&matte=true&matteColor=0xcccccc&image=<?= urlencode('http://knitspiring.com/freecyclestoop/images/' . $row[4]); ?>" width="175" height="175"><br /><a class="back-to-map" href="#">&#11013;</a><input type="image" name="claim" src="files/btn-claim.png">
	</form>
