...
<?php while($row = mysql_fetch_row($result)): ?> 
	<form method="POST">
		...
		<p>Number: <?php echo $row[0]; ?> <img src="http://www.mtv.com/shared/droplets/media/normalize_jpeg.jhtml?width=250&height=250&matte=true&matteColor=0xcccccc&image=<?= urlencode('http://www.keimdesign.com/stoop/images/' . $row[4]); ?>" width="250px"> <input type="submit" name="claim" value="claim">
	</form>
<?php endwhile; ?>
